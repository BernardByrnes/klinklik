...
export type PatientDuplicateResponse = { duplicate_candidates: Array<{ id: string; patient_no: string; display_name: string; match_score: number; last_visit_date: string | null; last_seen_at: string | null; }>; next_action: string; };
...
export const GENERATED_API_CONTRACT_SHA256 = "3f41e300b4c46b1ffc0119dc77d9fe4b1cab859f0ab07e1d35aff7df66b5a510";
